...
INSERT INTO menu_configs (key, title, path, icon, menu_group, is_visible, display_order) VALUES
    ...
    ('governanceUsers', 'Users',             '/governance/users',  'pi-users',      'Governance', TRUE, 22),
    ('governanceRoles', 'Roles',             '/governance/roles',  'pi-shield',     'Governance', TRUE, 23),
    ('governancePermissions', 'Permissions',  '/governance/permissions', 'pi-lock', 'Governance', TRUE, 24),
    ('governanceLogs',  'Logs',              '/governance/logs',   'pi-history',    'Governance', TRUE, 25),
    ('governanceAppConfig', 'App Config',    '/governance/app-config', 'pi-sliders-h', 'Governance', TRUE, 26),
    ('governanceStoreProcedure', 'Store Procedure', '/governance/store-procedure', 'pi-database', 'Governance', TRUE, 27),
    ('settings',        'Settings',          '/settings',          'pi-cog',        '—',          TRUE, 28)
