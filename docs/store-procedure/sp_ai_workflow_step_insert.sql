...
DROP FUNCTION IF EXISTS sp_ai_workflow_step_insert(INTEGER, VARCHAR, VARCHAR, VARCHAR, TEXT, VARCHAR, INTEGER);
...
BEGIN
    RETURN QUERY
    INSERT INTO ai_workflow_steps (workflow_id, name, step_type, skill_name, description, icon, step_order, is_latest_step)
    VALUES (p_workflow_id, p_name, p_step_type, p_skill_name, p_description, p_icon, p_step_order, p_is_latest_step)
    RETURNING
