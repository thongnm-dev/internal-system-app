...
BEGIN
    RETURN QUERY
    INSERT INTO ai_workflow_steps (workflow_id, name, step_type, description, icon, step_order)
    VALUES (p_workflow_id, p_name, p_step_type, p_description, p_icon, p_step_order)
    RETURNING
