...
async fn ensure_stored_procedures(client: &Client) -> AppResult<()> {
    let procedures: &[(&str, &str)] = &[
        ...
        // === Download History ===
        ("sp_download_hdr_insert", include_str!("../../../docs/store-procedure/sp_download_hdr_insert.sql")),
        ("sp_download_dtl_insert", include_str!("../../../docs/store-procedure/sp_download_dtl_insert.sql")),
        ("sp_download_history_select", include_str!("../../../docs/store-procedure/sp_download_history_select.sql")),
        ("sp_download_history_search", include_str!("../../../docs/store-procedure/sp_download_history_search.sql")),
        ("sp_download_dtl_update_moved_s3", include_str!("../../../docs/store-procedure/sp_download_dtl_update_moved_s3.sql")),
        ("sp_download_hdr_update_moved_local", include_str!("../../../docs/store-procedure/sp_download_hdr_update_moved_local.sql")),
        // === Upload History ===
        ("sp_upload_hdr_insert", include_str!("../../../docs/store-procedure/sp_upload_hdr_insert.sql")),
        ...
        ("sp_ai_model_select_list", include_str!("../../../docs/store-procedure/sp_ai_model_select_list.sql")),
        // === AI Task ===
